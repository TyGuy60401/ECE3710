...
LEFT:		CJNE A, 80h, RIGHT		; If only left button was pushed what to do
				...
				LCALL Display
				LJMP Game_over
RIGHT:	CJNE A, 80h, NONE		; If only right button was pushed what to do
				dec position
				LCALL Display
				LJMP Game_over
...
Check_buttons:	mov A, P2
								...
								ANL A, old_buttons		; If the buttons were different and they were pressed they stay.
								RET
; ------------- Display ------------
Display:	 ORL P3, #0FFh
					 ORL P2, #03h
					 ...
					 ret
; ------------- Game Over ----------------
Gave_over: CJNE position, 00H, NINE	 	; If position = 0 then the game is over
					 SJMP OVER
NINE: 		 CJNE postion, 08h, loop 		; If position = 8 then the game is over, else continue.
					 SJMP OVER
; ------------- Display LED's ----------------
DISP_LED: 	
